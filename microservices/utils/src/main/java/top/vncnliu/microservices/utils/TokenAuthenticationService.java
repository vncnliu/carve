package top.vncnliu.microservices.utils;
...
public class TokenAuthenticationService {
    ...
    private static final String SECRET = "P@mjoys";            // JWT密码
    ...
    public static Authentication getAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            try {
                ...
                throw new OAuth2Exception("token is fail");
            }
        } else {
            throw new OAuth2Exception("token is null");
        }
    }
}
